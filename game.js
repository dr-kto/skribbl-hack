!function(h, u, c, P) {
    ...
    function i(e, t) {
        ...
        case ve:
            ...
            D(i.querySelector("#copy-invite"), "click", lo),
            a.appendChild(i);
            break;
        case g:
    ...
    var Ye = u.querySelector("#select-mobile-keyboard-enabled")
      ...
      , He = {
        ...
        enter: function() {
            0 < this.input.length && (co(this.input),
            this.input = "",
            this.inputChanged())
        },
        toggleCaps: function() {
    ...
    function ia(e, t) {
        ...
        Ja = setInterval(function() {
            ...
            L.id == j && (e = Xa),
            L.id == X && (e = ja),
            Za.style.animationName = Qa < e ? Qa % 2 == 0 ? "rot_left" : "rot_right" : "none",
            Qa < e && E.playSound(En),
            Qa <= 0 && eo()
        }, 1e3),
    ...
    function Na(e) {
        ...
        case va:
            ...
            r = Pa(o, i).getBoundingClientRect(),
            o = .9 * (r.bottom - r.top),
            i.style.width = o + "px",
            i.style.height = o + "px",
    ...
    function Oa(e, t) {
        ...
        (n.element.avatar = r).appendChild(n.element.drawing),
        o.appendChild(r),
    ...
    function Ha() {
        ...
        null == za ? za = pe(Fn, t, [zn], function(e, t, n) {
        ...
        za.element.style.display = 1 < t ? "" : "none"
    }
    function Ua() {
    ...
    var Ba = [];
    for (var Ga = it.querySelectorAll('*[id^="item-"]'), _a = 0; _a < Ga.length; _a++) {
        var Va = {
            id: Ga[_a].id.replace("item-settings-", ""),
            element: Ga[_a],
            index: Ga[_a].dataset.setting
        };
        Ga[_a].item = Va,
        Ba.push(Va),
        D(Ga[_a].item.element, "change", function() {
            var e = this.value;
    ...
    function to(e) {
        Qa = e,
        Za.textContent = Qa,
        Hn.querySelector(".mobile .drawtime span").textContent = Qa + "s"
    }
    var no, t = u.querySelector("#tutorial"), ao = t.querySelectorAll(".page"), oo = pe(t.querySelector(".navigation"), ao.length, [t.querySelector(".pages")], function(e, t, n) {
        n && clearInterval(ro);
        for (var a = 0; a < ao.length; a++)
            ao[a].classList.remove("active");
        ao[t].classList.add("active")
    }), ro = setInterval(function() {
        oo.selected < 4 ? ge(oo, oo.selected + 1, !1) : ge(oo, 0, !1)
    ...
    D([u.querySelector("#copy-invite"), u.querySelector("#modal-player-button-invite")], "click", lo),
    ...
    for (var uo = u.querySelectorAll("[data-translate]"), ho = 0; ho < uo.length; ho++) {
        var po = uo[ho];
        Ve(po, po.dataset.translate)
    }
    for (var mo = Be[p.displayLang], go = 0; go < Ge.length; go++) {
        var fo = Ge[go]
          , yo = _e(mo, fo.key);
        "text" == fo.type && (fo.element.textContent = yo),
        "placeholder" == fo.type && (fo.element.placeholder = yo)
    }
    function vo(e) {
        no.parts[e].classList.remove("bounce"),
        no.parts[e].offsetWidth,
        no.parts[e].classList.add("bounce")
    }
    ...
    (no = de(p.avatar)).classList.add("fit"),
    it.appendChild(no),
    D(t, "click", function() {
    ...
    for (var bo = Math.round(8 * Math.random()), So = u.querySelector("#home .logo-big .avatar-container"), ko = 0; ko < 8; ko++) {
        var wo = [0, 0, 0, -1]
          , wo = (wo[0] = ko,
        wo[1] = Math.round(100 * Math.random()) % z,
        wo[2] = Math.round(100 * Math.random()) % H,
        100 * Math.random() < 1 && (wo[3] = Math.floor(20 * Math.random())),
        Xn && 100 * Math.random() < 35 && (wo[3] = 96 + Math.floor(4 * Math.random())),
        de(wo, 0, bo == ko));
        wo.index = ko,
        So.appendChild(wo),
        D(wo, "click", function() {
